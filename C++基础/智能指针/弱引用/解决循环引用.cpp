...
int main(){
    cout<<"Creating parent and child with weak reference..."<<endl;
    ...
    cout<<"Check parent through weak reference..."<<endl;
    if(auto locked=child->parent.lock()){
        cout<<"Successfully got parent through weak reference: "<<locked->name<<endl;
    }else{
        cout<<"Failed to get parent - weak reference expired"<<endl;
    }
